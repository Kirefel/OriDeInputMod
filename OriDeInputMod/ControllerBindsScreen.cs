...
namespace OriDeInputMod
{
    public class ControllerBindsScreen : CustomOptionsScreen
    {
        public override void InitScreen()
        {
            ...
            this.AddControllerBind("Cancel", () => ControllerRebinds.ControllerRebindings.Cancel, k => ControllerRebinds.ControllerRebindings.Cancel = k);
            this.AddControllerBind("Proceed", () => ControllerRebinds.ControllerRebindings.ActionButtonA, k => ControllerRebinds.ControllerRebindings.ActionButtonA = k);
